...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/marieweinz/django-rent-a-cat-dev_clara/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/marieweinz/django-rent-a-cat-dev_clara/env/bin/deactivate.nu'
